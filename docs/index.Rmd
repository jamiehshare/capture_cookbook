...
```{r gg-treemap-2, fig.cap = "A treemap showing part-to-whole relationship of social media mentions within the whole conversation using the size and colour of rectangles to encode values", fig.width=6}
treemap <- read_rds("~/Documents/R/capture_cookbook/data/treemap.rds")
...
```{r, gg-wlo, fig.cap = 'WLO plot shows how word usage changes between categories within our data'}
...
```{r gg-highlight-good, fig.height=3, fig.cap = 'By highlighting a key element of the chart, it clearly enables the audience to know what is the important category in our data driven narative and the key take home message}
set.seed(1234)
line_nice <- example %>% 
  mutate(created_time = floor_date(created_time,
                                   unit = "day")) %>% 
