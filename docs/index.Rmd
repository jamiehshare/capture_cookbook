...
In line with this, this document will not teach you R or the technical aspects of creating these plots. Instead, its primary goal is to help you grasp the purpose and appropriate usage of visualisations in our work. By doing so, it empowers everyone to confidently explain the key insights, strengths, and weaknesses conveyed by different types of plots.
...
*Please note that this is a very high level overview of UMAP. As explained previously, the purpose of this Cookbook is not to get a thorough understanding of statistics and Data Science, but rather empower solid data visualisation principles and understanding from an interpretation perspective. For a more thorough overview of UMAP please see REF*
...
As mentioned in the [pie chart section](#piechart), adding labels is highly recommended for pie charts and donught charts:
...
line_busy <- example %>% 
  ...
  scale_colour_manual(values = msft_cols) +
  # scale_colour_manual(values = c(viridis_pal(option = "viridis")(1),
  #                                viridis_pal(option = "viridis")(15)[4],
  #                                viridis_pal(option = "viridis")(15)[7],
  #                                viridis_pal(option = "viridis")(15)[11],
  #                                viridis_pal(option = "viridis")(100)[97])) +
  lims(x = c(as_date("2018-10-15"), as_date("2018-11-03"))) +
  labs(x = "Date",
       y = "Number of posts",
       title = "Busy",
